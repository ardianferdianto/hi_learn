...
class CategoriesController extends ForumAppController {
	...
	public function view($slug) {
		...
		if (($slug == 'antar-ptk') && $this->Auth->user('group_id')==3){
			$this->redirect(array('controller'=>'home','action'=>'index','plugin'=>'forum'));
			$this->Session->setFlash('Anda tidak dapat mengakses halaman ini','flash_erorr');
		}
