...
<?php echo $form->create('Report', array('url' => array('controller' => 'reports', 'action' => 'posts', 'admin' => true))); ?>
<div class="forumWrap">
    ...
    <tr>
        ...
        <th><?php echo $paginator->sort(__d('forum', 'Reported By', true), 'Reporter.nama'); ?></th>
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        ...
        <td><?php echo $report['Post']['content']; ?> (<?php echo $html->link(__d('forum', 'View Topic', true), array('controller' => 'topics', 'action' => 'view', $report['Post']['topic_id'], 'admin' => false)); ?>)</td>
