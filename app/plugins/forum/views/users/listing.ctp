...
<tr>
	<td class="ar"><?php echo $form->input('nama', array('div' => false, 'label' => __d('forum', 'Search Users (nama)', true) .': ')); ?></td>
...
<div class="forumWrap">
    ...
    <tr>
        <th><?php echo $paginator->sort(__d('forum', 'nama', true), 'User.nama'); ?></th>
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        <td><?php echo $html->link($user['User']['nama'], array('action' => 'profile', $user['User']['id'])); ?></td>
