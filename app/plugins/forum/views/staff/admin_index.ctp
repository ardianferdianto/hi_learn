...
<div class="forumHeader">
	<h2><?php __d('forum', 'Staff &amp; Moderator'); ?></h2>
</div>

<?php $session->flash(); ?>

<div class="forumOptions">
	<?php echo $html->link(__d('forum', 'Tambah Staff', true), array('action' => 'add_access')); ?>
	<?php echo $html->link(__d('forum', 'Tambah Level Akses', true), array('action' => 'add_access_level')); ?>
    <?php echo $html->link(__d('forum', 'Tambah Moderator', true), array('action' => 'add_moderator')); ?>
</div>
...
<div class="forumWrap">
	<h3><?php __d('forum', 'Level'); ?></h3>
     
    <table cellspacing="0" class="table">
    <tr>
        <th style="width: 33%"><?php __d('forum', 'Jabatan'); ?></th>
...
<div class="forumWrap">
    ...
    <tr>
        ...
        <th style="width: 25%"><?php __d('forum', 'Level Akses'); ?></th>
        <th style="width: 25%"><?php __d('forum', 'Pada tanggal'); ?></th>
    ...
    <tr id="staff_<?php echo $user['Access']['id']; ?>">
        ...
        <td class="ac gray">
        	...
        	<?php echo $html->link(__d('forum', 'Hapus', true), array('action' => 'delete_access', $user['Access']['id']), array('confirm' => __d('forum', 'Apa anda yakin ingin menghapus?', true))); ?>
        </td>
    </tr>
...
<div class="forumWrap">
    ...
    <tr>
        <th style="width: 25%"><?php __d('forum', 'User'); ?></th>
        <th style="width: 25%"><?php __d('forum', 'Moderasi'); ?></th>
        <th style="width: 25%"><?php __d('forum', 'Pada tanggal'); ?></th>
        <th style="width: 25%"><?php __d('forum', 'Options'); ?></th>
    </tr>
    ...
    <tr>
    	<td colspan="4" class="empty"><?php __d('forum', 'Tidak ada moderator.'); ?> <?php echo $html->link(__d('forum', 'Tambah Moderator', true), array('action' => 'add_moderator')); ?>.</td>
    </tr>
