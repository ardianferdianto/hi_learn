...
<!--<div class="forumOptions">
	<?php echo $html->link(__d('forum', 'Tambah Forum', true), array('action' => 'add_forum')); ?>
    <?php echo $html->link(__d('forum', 'Tambah Category', true), array('action' => 'add_category')); ?>
</div>-->
...
<div class="forumWrap" id="forum_<?php echo $forum['Forum']['id']; ?>">
    ...
    <tr>
        ...
        <th><?php __d('forum', 'Hak baca'); ?></th>
        <th><?php __d('forum', 'Hak post'); ?></th>
        <th><?php __d('forum', 'Balas'); ?></th>
        <th><?php __d('forum', 'Polling'); ?></th>
    ...
    <tr id="category_<?php echo $category['id']; ?>">
        ...
        <td class="ac gray">
        	...
        	<?php echo $html->link(__d('forum', 'Hapus', true), array('action' => 'delete_category', $category['id'])); ?>
        </td>
    </tr>
