...
<head>
    ...
    <title><?php echo $title_for_layout . " " . $appLicationName; ?></title>
    <?php
...
<body>
	...
	<div id="wrap">
		<?php $session->flash(); ?>
		<!-- <img src="<?php echo $this->webroot;?>art/install/logo-edu-small.png" id="main"> -->
		...
		<div id="content">
			...
			<p class="footer <?php if ($footerSpecial == true){echo 'special';} ?>">
				<small> 
						&#169; Copyright 2015 | Powered by EDUSOFT
						<br/>
