...
--
-- Host: localhost
-- Generation Time: Feb 24, 2016 at 01:57 PM
...
INSERT INTO `assets` (`id`, `presentation_id`, `kelas`, `matapelajaran`, `author`, `title`, `jenis`, `created_by`, `content`, `file`, `dir`, `mimetype`, `filesize`, `created`, `modified`) VALUES
(40, NULL, 0, 0, 'admin', '', 2, 1, 'asdadadasdasd', NULL, NULL, NULL, NULL, '2016-02-03 17:42:03', '2016-02-03 17:42:03');
...
CREATE TABLE IF NOT EXISTS `labs` (
  ...
  `modified` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8138 ;
...
CREATE TABLE IF NOT EXISTS `presentations` (
  ...
  `cover_color` varchar(30) DEFAULT NULL,
  `dash_color` varchar(30) DEFAULT NULL,
  `deskripsi` text,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `presentations` (`id`, `author`, `title`, `cover_color`, `dash_color`, `deskripsi`, `created`, `modified`) VALUES
(1, '', NULL, NULL, NULL, '{Deskripsi singkat presentasi}', '2016-02-24 00:10:46', '2016-02-24 00:10:46'),
(2, '', NULL, NULL, NULL, '{Deskripsi singkat presentasi}', '2016-02-24 00:12:51', '2016-02-24 00:12:51'),
(3, '', NULL, NULL, NULL, '{Deskripsi asdasdasd presentasi}', '2016-02-24 00:15:38', '2016-02-24 00:15:38'),
(4, '', '{JUDUL asdasdasd}', NULL, NULL, '{Deskripsi asdasdasd presentasi}', '2016-02-24 00:17:40', '2016-02-24 00:17:40'),
(5, NULL, 'asdadasd', NULL, NULL, 'asdasdasdadasdasd', '2016-02-24 00:18:32', '2016-02-24 00:18:32'),
(6, 'Admin', 'Presentasi ardian', NULL, NULL, 'Huehehehehe', '2016-02-24 00:24:43', '2016-02-24 00:24:43'),
(7, 'Admin', 'Presentasi ardian', NULL, NULL, 'presentasi mengenai materi matematika', '2016-02-24 11:28:51', '2016-02-24 11:28:51'),
(8, 'Admin', '{JUDUL PRESENTASI}asdasdasd', NULL, NULL, '{Deskripsi singkat presentasi}', '2016-02-24 11:29:18', '2016-02-24 11:29:18'),
(9, 'Admin', 'asdasdasdas', NULL, NULL, '{Deskripsi singkat presentasi}', '2016-02-24 11:30:10', '2016-02-24 11:30:10'),
(10, 'Admin', 'zxczxczxczxc', NULL, NULL, '{Deskripsi singkat presentasi}', '2016-02-24 11:33:57', '2016-02-24 11:33:57'),
(11, 'Admin', 'Presentasi ard', NULL, NULL, 'sasdasdasdasd', '2016-02-24 11:37:49', '2016-02-24 11:37:49');
