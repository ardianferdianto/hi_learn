...
<div class="container">
	...
	<div class="content">
		...
		<div id="rg-gallery" class="rg-gallery">
			<div class="rg-thumbs" style="float:right; width:35%;margin-top:149px;">
				...
				<div class="es-carousel-wrapper">
					...
					<div class="es-carousel">
						<ul style="width:400px; display: block; margin-left: 0px; margin-top: 25px;">
							<?php foreach ($videos as $item) {?>
								<li style="margin-right: 3px; width: 120px;">
