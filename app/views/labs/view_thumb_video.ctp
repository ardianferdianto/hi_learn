<div style="float:left;margin-right:20px">
	<?php echo $html->link(__('Delete', true), array('action' => 'delete',$lab['Lab']['id'],$lab['Lab']['labtype']), array('class'=>'button-pembelajaran','id'=>'delete-ebook'), sprintf(__('Apakah anda yakin ingin menghapus # %s?', true), $lab['Lab']['title'])); ?>
