...
<div id="newebook">
	...
	<?php echo $form->create('Lab',array('action'=>'search','enctype'=>'multipart/form-data'));?>
    ...
    jQuery.ajax({
      ...
      success: function (data) {
        ...
        if(data == 'false'){
            ...
            jQuery('#bookshelf').html('');
            jQuery('#bookshelf').append('<p class="booknotfound" style="font-size:1.5em;color: #7b4520;margin: 70px 0 0 300px;font-weight: 700;">Tidak ditemukan ebook</p>');
        }else{
