		...
		<div class="rg-caption-wrapper">
			<div class="rg-caption" style="display:none;">
				...
				<div style="display: block;float: left;margin: 0 auto;margin-top: 10px;text-align: center;width: 100%;">
					<a href="/esms_sd/labs/edit/2/106" class="button-pembelajaran edit-ebook" id="edit-ebook" rel="modal">Edit</a>

					<a href="/esms_sd/labs/../files/labs/bahan_kimia_bagian_1.flv" class="button-pembelajaran download-ebook" id="download2-btn">Download</a>

					<a href="/esms_sd/labs/delete/106/2" class="button-pembelajaran delete-video" id="delete-ebook" onclick="return confirm('Apakah anda yakin ingin menghapus item ini?');">Delete</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="container">
	...
	<div class="content">
		<div class="headertitle">
			...
			<a href="#upload-ebook" rel="modal" id="uploadebook" class="tooltip" title="Upload Video"><img src="<?php echo $this->webroot;?>resources/images/add_flat.png"></a>
			...
			<?php echo $form->create('Lab',array('action'=>'search_video','type'=>'get','enctype'=>'multipart/form-data'));?>
		      ...
		      <input type="search" id="searchquery_ebook" placeholder="Lakukan pencarian video disini, kemudian tekan enter" value="<?php echo $keyword;?>" name="searchquery">
		    <?php echo $form->end();?>
...
jQuery('a.viewvideo').live('click', function() {
    ...
    beforeShow:function(){
        jwplayer("containerPlayer").setup({
            ...
            'file': '<?php echo $this->webroot;?>files/labs'+videoplay,
