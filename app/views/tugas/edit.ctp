...
<div class="tugas form">
	...
	<h2 id="tugastitle">Edit Tugas : <?php echo $tugas['Tuga']['title'];?></h2>
<?php echo $form->create('Tuga', array('style' => 'margin-left: 17em;margin-right: 14em;background: rgba(255,255,255,0.0);'));?>
	...
	<?php
		...
		echo '</p>';
		echo '<p>';
		echo $form->input('start_date',array('label'=>'Tanggal diPublish'));
		echo '</p>';
		echo '<p>';
		echo $form->input('expiration_date',array('label'=>'Tanggal akhir penyerahan tugas'));
		echo '</p>';
	?>
	</fieldset>
