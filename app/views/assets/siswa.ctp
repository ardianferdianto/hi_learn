<div id="presentase-template-content" class="clearfix">
	...
	<div id="presentase-content2" class="clearfix">
				...
				?>
					<tr<?php echo $class;?>>
						...
						<td class="actions">
							...
							<?php elseif ($groupAuth == 3 && ($assetGuru['Asset']['author']== $loggedInId)) :
		...
		<ul id="menu_list_presentase">
			...
			<li><a class="button-pembelajaran" id="back-btn-black" href="<?php echo $this->webroot; ?>users/presentase_siswa/<?php echo $kelas;?>"></a></li>
