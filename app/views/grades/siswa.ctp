...
<a class="shortcut-button-small" href="<?php echo $this->webroot; ?>quizz_points/home" id="addData_left">
	<span>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $html->link(__('Lihat History Test', true), array('controller' => 'quizz_points','action' => 'history', $user['User']['id'])); ?>
