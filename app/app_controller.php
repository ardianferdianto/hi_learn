...
class AppController extends Controller {
	...
	var $components = array('Auth', 'Acl','Cookie','RequestHandler');
 	var $helpers = array('Form','Html','Time','Javascript','Ajax','Time');
	...
	function uploadFiles($folder, $formdata, $itemId = null) {
		...
		$permitted = array('image/gif','image/jpeg','image/pjpeg','image/png','application/pdf','application/msword','video/x-flv');
